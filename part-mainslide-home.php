    ...
    <div class="container_full">
        ...
        <div class="wrap__video" id="video_playandpause">
				<div id="video-container">
					<video loop autoplay muted playsinline id="video" width="100%" poster="data:image/gif,AAAA" class="fullscreen-bg__video">
					<!-- <source src="video/the-surin-landing-page-vdo.WebM" type="video/webm">
					<source src="video/the-surin-landing-page-vdo.ogv" type="video/ogv"> -->
					<!--source src="<?=WCL_TEMPLATE?>/video/stay-hotel-3.mp4" type="video/mp4"-->
