...
//             echo '
//             <style>.wrap__allamenities.moreroom ul:last-child {margin-top: 0px;} </style>
//             <div class="wrap__allamenities moreroom">
//             <h4 class="aniset" animate-style="fadeInUpSm" animate-time="1s" animate-delay="0s">Amenities</h4>';

//             the_field('amenities');
//             the_field('amenities_right');
...
<?php 
    ...
    //if($rows) {
        //get_template_part("template-parts/part", "moreroom"); 
    //}
    //else { ?>
                ...
                <div class="wrap">
                    ...
                    <div class="wrap__facilities">
                        <div class="wrap">
                            ...
                            <?php echo get_field('amenities_right'); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php get_template_part("template-parts/part", "moreroom"); ?>
